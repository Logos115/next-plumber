...
export async function POST(req: Request) {
  ...
  const jobRef =
    body.jobNumber !== undefined && body.jobNumber !== null
      ? String(body.jobNumber).trim() || null
      : null;
  ...
  try {
      ...
      await logAction(
        {
          ...
          details: { type: "RETURN", quantity: qty, itemId: body.itemId },
        },
        tx
      );
    ...
    return NextResponse.json("Failed to record return", { status: 500 });
  }
}
